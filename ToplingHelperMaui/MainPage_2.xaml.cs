...
{
    public partial class MainPage_2 : ContentPage
    {
        ...
        private async void Button_Clicked(object sender, EventArgs e)
        {
            ...
            Shell.Current.Dispatcher.DispatchAsync(() => MessageBox.Show("流程约三分钟，请不要关闭窗口!"));
        ...
        private async void Worker()
        {
            ...
            try
            {
                ...
                if (!AddVpcIntoCen(client, toplingVpc, cenId, ToplingConstants.ToplingAliYunUserId))
                {
                    AppendLog("并网失败...");
                    // 并网失败
                    Shell.Current.Dispatcher.Dispatch(() => ShowFail(toplingVpc, cenId));
                    return;
                }
                AppendLog("并网完成...");
            ...
            {
                Shell.Current.Dispatcher.Dispatch(() => { SetInputs(true); });
            }
        ...
        private void AppendLog(string line)
        {
            ...
            Shell.Current.Dispatcher.Dispatch(() => { Log.Text = _logBuilder.ToString(); });
        }
